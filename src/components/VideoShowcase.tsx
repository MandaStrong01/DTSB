      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-gradient-to-r from-red-600 to-red-800 rounded-3xl p-8 md:p-12 text-center">
          ...
          <p className="text-xl text-red-100 mb-8 max-w-3xl mx-auto">
            The complete "MOVIE JULY 26 - Lip-synced Precision" documentary is now available for paid viewing on Vimeo. 
            Support our mission while experiencing this powerful story that's changing minds worldwide.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button 
              onClick={() => window.open('https://vimeo.com/ondemand/stoptheDoxxing', '_blank')}
              className="bg-white text-red-600 font-bold py-4 px-8 rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            >
              Watch on Vimeo - Paid
            </button>
